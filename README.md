...
<details><summary>Clicca qui per i dati completi del gruppo:</summary>
<p>
Ivan Valente 2147985<br>
Matteo Angelini 2101737
</p>
</details> 

## Descrizione
Questo progetto implementa un convertitore per i primi 1000 numeri interi da arabi a romani, includendo una funzionalità per la stampa dei numeri romani in formato AsciiArt.

## Stato del progetto
Di seguito sono riportati i risultati in tempo reale della Build Automation e dell'analisi statica (code coverage con Coveralls), ottenuti tramite GitHub Action:

[![Build Status](https://github.com/ivancodes1/Valente-Angelini_MTSS_2025-26/actions/workflows/ci.yml/badge.svg)](https://github.com/ivancodes1/Valente-Angelini_MTSS_2025-26/actions)
[![Coverage Status](https://coveralls.io/repos/github/ivancodes1/Valente-Angelini_MTSS_2025-26/badge.svg?branch=main)](https://coveralls.io/github/ivancodes1/Valente-Angelini_MTSS_2025-26?branch=main)
